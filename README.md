...
- ABA: الدفعة ستة فصول؛ كل فصل أربعة أسابيع دراسة وأسبوع اختبارات، يتبعه أسبوع إجازة فاصل.
- OBM Practitioner: ثلاث وحدات، أسبوعان لكل وحدة.
- OBM Advanced: الوحدات الرابعة والخامسة والسادسة، أسبوعان لكل وحدة.
